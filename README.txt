...
É possível realizar um sorteio de teste através dos arquivos na pasta Teste.
Você pode criar uma lista de participantes e utilizar os arquivos:
- chavesFamosas.py;
- sorteio.py;
- leitorDeAmigo.py.
E simular o seu sorteio! =)
